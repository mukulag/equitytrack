        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Your feedback helps improve Trade Journal. Send a quick message and we'll take a look.
                  </DialogDescription>
                </DialogHeader>
                <div className="mt-2">
          ...
          <div className="space-y-6 lg:pl-8 lg:border-l border-border/30">
            ...
            <Dialog open={supportOpen} onOpenChange={setSupportOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Support Trade Journal</DialogTitle>
                  <DialogDescription>
                    Consider supporting development with a small donation. Your contribution helps keep the project maintained.
                  </DialogDescription>
                </DialogHeader>

                <div className="p-6 rounded-xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 mt-2">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Every contribution helps keep this project alive</p>
                    </div>
                  </div>
